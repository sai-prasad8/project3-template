...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [DashboardComponent, JsonGeneratorComponent, XmlGeneratorComponent, OtherGeneratorComponent, ConfigGeneratorComponent, Config2GeneratorComponent, NgIf],
  template: `
